...
namespace PudelkoUnitTests
{
    ...
    public class UnitTestsPudelkoConstructors
    {
        ...
        [DataRow(1.0, 2.0, 3.0, 6.000)]
        [DataRow(5.0, 5.0, 5.0, 125.000)]
        [DataRow(1.3, 3.5, 5.1, 23.205)]
        public void Objetosc_Test(double a, double b, double c, double expectedObjetosc)
        {
            var p = new Pudelko(a, b, c);
            Assert.AreEqual(p.Objetosc, expectedObjetosc);
        }
            

        [DataTestMethod, TestCategory("Pole")]
        [DataRow(1.0, 2.0, 3.0, 22.000)]
        [DataRow(5.0, 5.0, 5.0, 150.000)]
        [DataRow(1.3, 3.5, 5.1, 58.060)]
        public void Pole_Test(double a, double b, double c, double expectedPole)
        {
            var p = new Pudelko(a, b, c);
            Assert.AreEqual(p.Pole, expectedPole);
        }
        ...
        [DataRow(5.0, 5.0, 5.0)]
        [DataRow(1.3, 3.5, 5.1)]
        public void Equals_Test(double a, double b, double c)
        {
        ...
        [DataRow(5.0, 5.0, 5.0)]
        [DataRow(1.3, 3.5, 5.1)]
        public void EqualOperator_Test(double a, double b, double c)
        {
            var p1 = new Pudelko(a, b, c);
            var p2 = new Pudelko(a, b, c);
            Assert.IsTrue(p1 == p2);
        ...
        [DataRow(5.0, 5.0, 5.0)]
        [DataRow(1.3, 3.5, 5.1)]
        public void UnequalOperator_Test(double a, double b, double c)
        {
            var p1 = new Pudelko(a, b, c);
            var p2 = new Pudelko(a, b, c);
        ...
        [DataRow(1.0, 2.0, 3.0, 2.0, 2.0, 2.0)]
        [DataRow(5.0, 5.0, 5.0)]
        public void UnequalOperator_Test(double a, double b, double c, double d, double e, double f)
        {
            var p1 = new Pudelko(a, b, c);
            var p2 = new Pudelko(d, e, f);
            Assert.AreEqual(p1 + p2, new Pudelko(a+d, b+e, c+f));
        }
